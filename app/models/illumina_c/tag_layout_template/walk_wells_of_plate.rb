module IlluminaC::TagLayoutTemplate::WalkWellsOfPlate
  def generate_tag_layout(plate, tagged_wells)
    ...
    group.each_with_index do |(well, pool_id, empty), index|
      throw :unacceptable_tag_layout if tags.size <= index && !empty
